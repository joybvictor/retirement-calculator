...
def main():
    ...
    st.title("💰 US Retirement Calculator - Needs-Based Withdrawals")
    st.markdown("""
    **Calculates exactly how much you need to withdraw** (not arbitrary 4% rule) to cover expenses, taxes, and Medicare.
